...
--
create or replace function create_schema_0_0_3() returns void as $$
declare
...
begin
    ...
    case schema_count
        when 0 then
            ...
            insert into schema_version(schema_version) values('0.0.3');
        when 1 then
...
select create_schema_0_0_3() is null;

-- clean up
drop function create_schema_0_0_3();