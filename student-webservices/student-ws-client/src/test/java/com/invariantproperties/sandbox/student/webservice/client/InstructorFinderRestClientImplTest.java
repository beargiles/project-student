...
public class InstructorFinderRestClientImplTest {
    ...
    public void testGetAllInstructorsEmpty() {
        ...
        List<Instructor> results = client.findAllInstructors();
    ...
    public void testGetInstructor() {
        ...
        Instructor actual = client.findInstructorByUuid(expected.getUuid());
    ...
    public void testGetInstructorMissing() {
        ...
        client.findInstructorByUuid(UUID);
    }
