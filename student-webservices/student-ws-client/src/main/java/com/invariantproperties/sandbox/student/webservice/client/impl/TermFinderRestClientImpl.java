...
public class TermFinderRestClientImpl extends AbstractFinderRestClientImpl<Term> implements TermFinderRestClient {
    ...
    public List<Term> findAllTerms() {
        Term[] terms = super.getAllObjects(EMPTY_TERM_ARRAY);
     ...
     */
    @Override
    public Term findTermById(final Integer id) {
     ...
     */
    @Override
    public Term findTermByUuid(final String uuid) {
     ...
     */
    @Override
    public List<Term> findTermsByTestRun(final TestRun testRun) {
        throw new UnsupportedOperationException();
    }
}
